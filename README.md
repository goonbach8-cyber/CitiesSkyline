...
v0.4.1 ist ein deutlich groesserer Schritt vom Technik-Prototypen Richtung echtes City-Builder-Spiel.
...
## v0.4.1 Performance-Patch

Diese Version aendert bewusst kaum Gameplay, sondern optimiert die Browser-Performance:

- Terrain und Wasser werden einmal als Mesh aufgebaut statt tausende einzelne Boden-Cubes pro Frame zu zeichnen.
- Terrainhoehen, Wasser und Ufer werden beim Start gecacht.
- Baeume/Felsen werden einmal erzeugt und nach Kameradistanz ausgeblendet.
- Gebaeude nutzen Distanz-LOD: volle Details in Kameranaehe, vereinfachte Modelle in der Ferne.
- Strassen nutzen ebenfalls ein Detail-LOD.
- Zonen-Overlays werden nur angezeigt, wenn ein Zonenwerkzeug aktiv ist.
- Im Web-Build ist 4x MSAA standardmaessig deaktiviert.
- Die obere Leiste zeigt die aktuelle FPS-Zahl an.
