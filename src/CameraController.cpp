...
void CameraController::Update(float dt) {
    ...
    target_.x = Clamp(target_.x, -92.0f, 92.0f);
    target_.z = Clamp(target_.z, -92.0f, 92.0f);
    RebuildCamera();
}
