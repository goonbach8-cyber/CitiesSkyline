...
void BuildingRenderer::DrawBuilding(const Building& b, Vector3 center, float lotWidth, float lotDepth) {
    ...
    if (!b.powered) {
        DrawCylinder({center.x, center.y + 0.22f, center.z}, 0.05f, 0.05f, 0.42f, 8, Color{232, 183, 54, 255});
    }
    if (!b.watered) {
        DrawCylinder({center.x + 0.13f, center.y + 0.22f, center.z}, 0.05f, 0.05f, 0.42f, 8, Color{67, 151, 222, 255});
    }
}
