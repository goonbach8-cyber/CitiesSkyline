...
public:
    static void DrawBuilding(const Building& b, Vector3 center, float lotWidth, float lotDepth, bool detailed = true);
...
private:
    ...
    static void DrawSimplified(const Building& b, Vector3 p, float lotW, float lotD);
